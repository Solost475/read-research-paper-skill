...
It distills S. Keshav's *How to Read a Paper* into an operational workflow for rapid screening, evidence-linked understanding, and reconstruction-level critique. The skill adds explicit source anchors, document-instruction isolation, and modern literature-search safeguards.

中文简介：这是一个面向 Codex 的论文阅读 Skill，支持快速筛选、证据级理解、复现式深读，以及从种子论文扩展相关工作的流程。
